...
import { ManagerRopaTab } from '@/components/manager/ropa-tab';
  ...
  return (
    <div className="min-h-screen bg-[#091833] flex text-white font-sans overflow-hidden">
      ...
      <div className="flex-1 h-screen overflow-y-auto relative">
        <div className="p-6 pt-20 md:p-10 lg:p-12 xl:p-16 max-w-[1400px] mx-auto h-full">
          {activeTab === 'dashboard' && <ManagerDashboardTab />}
          {activeTab === 'ropa' && <ManagerRopaTab />}
        </div>
      </div>
    </div>
  );
